...
@class CWPinTextField;

extern NSString *const kCWPinEntryActiveNotif;
extern NSString *const kCWPinEntryCompleteNotif;
extern NSString *const kCWPinEntryAuthorizedNotif;
extern NSString *const kCWPinEntryUnauthorizedNotif;

@interface CWPinEntry : UIView <UITextFieldDelegate> {
    NSString *pinNum;
    CGRect origFrame;
    CGRect bigFrame;
    BOOL editing;
    ...
    CWPinTextField *keyOne;
    CWPinTextField *keyThree;
    CWPinTextField *keyTwo;
    CWPinTextField *keyFour;
    UIView *inputView;
    BOOL enabled;
}
