...
@class SpatialResultVO;
@class CMDeviceMotion;
@class CWPinEntry;

@interface SpatialTestViewController : UIViewController <UIAlertViewDelegate> {
    DataManager *manager;
    CWPinEntry *pinEntry;
    
    IBOutlet UILabel *progressLabel;
    IBOutlet UILabel *headingText;
    IBOutlet UILabel *attributionLabel;
    IBOutlet UIImageView *shadowLine;
    IBOutlet UIButton *nextButton;

    SpatialResultVO *result;
    NSTimer *quizTimer;
    int currentTime;
    int timeLimit;
    UIImageView *questionImage;
    CWRadioButtonGroup *radioQuestion;
    BOOL answerSelected;
    NSNumber *answerId;
}
