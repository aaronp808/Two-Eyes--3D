...
@interface QuizResultVO : NSObject {
    QuestionType type;
    NSNumber *round;
    NSNumber *questionId;
    NSNumber *answerId;
    ...
    NSDate *endTime;
    NSNumber *duration;
    NSMutableArray *attitudeData;
    NSMutableArray *accelData;
...
@property (nonatomic, retain) NSMutableArray *attitudeData;
@property (nonatomic, retain) NSMutableArray *accelData;
@property (nonatomic, retain) NSMutableArray *drawingData;
