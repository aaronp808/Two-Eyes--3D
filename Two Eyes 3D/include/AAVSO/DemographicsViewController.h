...
@class CWRadioButtonGroup;
@class CWPinEntry;

static int const kInputFieldHeight;
static int const kInputFieldWidth;

@interface DemographicsViewController : UIViewController <UIPickerViewDelegate, UIAlertViewDelegate> {
    DataManager *manager;
    CWPinEntry *pinEntry;
    CWRadioButtonGroup *genderSelect;
    CWRadioButtonGroup *difficultySelect;
    CWRadioButtonGroup *knowledgeSelect;
    int minimumAge;
    int maximumAge;
    int ageSelected;
    BOOL genderSelected;
    BOOL difficultySelected;
    BOOL knowledgeSelected;
    BOOL ageSelecting;
    UITapGestureRecognizer *offKeyboardTap;
    UIPickerView *agePickerView;
    UIPopoverController *agePopover;
    IBOutlet UIButton *ageButton;
    IBOutlet UIButton *beginButton;
    IBOutlet UITextView *nameInput;
    IBOutlet UITextView *emailInput;
    IBOutlet UILabel *difficultyLabel;
    IBOutlet UILabel *knowledgeLabel;
