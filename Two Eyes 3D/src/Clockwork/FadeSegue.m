...
//  Two Eyes 3D
//
//  Created by Jerry Belich on 5/21/12.
//
...
- (void)perform {
    ...
    [UIView transitionWithView:sourceVC.navigationController.view
                      duration:0.5f
                       options:UIViewAnimationOptionTransitionCrossDissolve
                    animations:^{
                        // This will REPLACE instead of PUSH
                        UINavigationController *nav = sourceVC.navigationController;
                        [nav popViewControllerAnimated:NO];
                        [nav pushViewController:destinationVC animated:NO];
                        // This will PUSH instead of REPLACE
                        //[sourceViewController.navigationController pushViewController:destinationVC animated:NO];
                    } 
